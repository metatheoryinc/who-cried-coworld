...
await build({entryPoints:{'game':'src/game/main.ts','player':'src/player/main.ts','llm-player':'src/player/llm-main.ts','diagnostic-player':'src/player/diagnostic-main.ts'},bundle:true,platform:'node',target:'node24',format:'esm',outdir:'build',outExtension:{'.js':'.mjs'},packages:'external',sourcemap:true});
