...
const config=lib.GameConfig.parse({mode:allBots?'bots':'human',seed:process.env.WCW_SEED,tokens:Array.from({length:9},()=>randomUUID()),players,setup:process.env.WCW_SETUP??'random',maxDays:8,player_connect_timeout_seconds:30,...(smoke?{humanTimers:allBots?{dayMs:600,voteMs:200,coordinationMs:200,nightMs:200,transitionMs:100}:{dayMs:6000,voteMs:8000,coordinationMs:2000,nightMs:8000}}:{})});
