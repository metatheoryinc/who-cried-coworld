...
const settingLabels:Record<string,{title:string;description:string}>={
 ...
 player_connect_timeout_seconds:{title:'Connection wait (seconds)',description:'Connection grace period. Play waits for the first human, then begins when all seats connect or this wait expires. Late humans can reconnect to their own seats.'},
};
...
const manifest={
 ...
 variants:[
  {id:'human-llm',name:'Play · LLM host',description:'For one to nine humans, with AI filling the other seats. Claim human seats in the lobby before starting. An LLM host selects speakers; failed or late calls use deterministic fallback. Random NewD3 setup and human-paced turns. Choose opponent policies separately. Requires hosted inference or runtime credentials.',game_config:{mode:'human',moderator:'llm',humanSlots:[],players,setup:'random',maxDays:8,player_connect_timeout_seconds:30}},
  {id:'human',name:'Play · Classic host',description:'For one to nine humans, with AI filling the other seats. Claim human seats in the lobby before starting. The classic host selects speakers deterministically without model calls. Random NewD3 setup and human-paced turns. Choose opponent policies separately.',game_config:{mode:'human',moderator:'default',humanSlots:[],players,setup:'random',maxDays:8,player_connect_timeout_seconds:30}},
